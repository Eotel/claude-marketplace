...
Add your project-specific rules to `CLAUDE.md`. This agent will reference them automatically.
...
- [Core functionality that must stay]
- [Critical integrations]

### SAFE TO REMOVE
- [Types of code safe to remove]
- [Common cleanup targets]

### ALWAYS VERIFY
- [Code that needs verification before changes]
