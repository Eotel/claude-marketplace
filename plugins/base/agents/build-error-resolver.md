...
Add project-specific build issue patterns to your `CLAUDE.md` file. This agent will reference them automatically.

### Template

```markdown
## Build Issues Specific to This Project

### [Framework/Library Name]
- Issue pattern: [description]
- Common fix: [solution approach]
