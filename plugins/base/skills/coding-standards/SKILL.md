...
const productSearchQuery = 'laptop'
 ...
 * @throws {Error} If search service fails or is unavailable
 *
 * @example
 * ```typescript
 * const results = await searchItems('wireless headphones', 5)
 * console.log(results[0].name) // "Sony WH-1000XM5"
 * ```
 */
